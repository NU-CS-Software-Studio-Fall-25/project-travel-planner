...
class OpenaiService
  ...
  def build_prompt
    ...
    <<~PROMPT
    You are a professional travel planner. Based on the following travel preferences, suggest 3 travel destinations that STRICTLY match ALL the user's requirements.
