...
class OpenaiService
  ...
  def build_prompt
    ...
    <<~PROMPT
      ...
      7. Have a safety score of at least #{@preferences[:safety_preference] || 5}/10
      ...
      - "safety_score": Safety rating 1-10 (must be at least #{@preferences[:safety_preference] || 5}).
      ...
      - Minimum Safety Score: #{@preferences[:safety_preference]}/10
      ...
      destinations.map do |dest|
        {
          ...
          safety_score: dest[:safety_score]&.to_i || 5,
